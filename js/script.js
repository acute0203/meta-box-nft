$(function() {
  ...
  $('.c-toggle').on('click', function() {{
    let x = document.querySelector( '.c-header__menu' );
...
$('a[href*="#"]')
  ...
  .click(function(event) {
    ...
    if (
      ...
      var nftID = this.hash.slice(1).replace("ex","");
      ...
      if (target.length) {//target.length
        ...
        console.log(nftID);
        document.location.href = document.location.origin+"/owner.html?item="+nftID;
    }
    }
  });
